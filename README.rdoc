...
- To change images got to <tt>/app/assets/images/</tt> and just rename your png image to avatar.png
- Changes the twitter feed can be done by removing lines 7 - 11 at <tt>/app/views/pages/about.html.erb</tt> also you can go to your twitter and insert your own feed in its place
